...
5. Add [personalisation]({% link pages/using-nhs-notify/personalise-your-messages/overview.md %}) fields by using single curly brackets with d. at the start. For example, {d. appointmentDate}.

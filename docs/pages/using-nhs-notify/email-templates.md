...
You can personalise your emails by adding personalisation fields. [Learn how to use personalisation]({% link pages/using-nhs-notify/personalise-your-messages/overview.md %}).
